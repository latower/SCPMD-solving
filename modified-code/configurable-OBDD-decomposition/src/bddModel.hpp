...
class BDDModel : public Space
{
  ...
  public:
    ...
    // BDDModel(BDDModel &s, Gecode::Search::Options &o) : 
    BDDModel(BDDModel &s) : 
                  Space(s),
                  bdd(s.bdd),
                  fvars(s.fvars),
...
class MaxProbModel : public BDDModel
{
  public:
    ...
    // MaxProbModel(MaxProbModel &s, Gecode::Search::Options &o) : BDDModel(s, o) {}
    // MaxProbModel(MaxProbModel &s, Gecode::Search::Options &o) : BDDModel(s) {}
...
class MinCardModel : public BDDModel
{
  public:
    ...
    // MinCardModel(MinCardModel &s, Gecode::Search::Options &o) : BDDModel(s, o) {}
